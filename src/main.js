...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['ufdb348d53532a57228f045ecfaa00f8d','ue5060e54a4ed380dcafd0a2213592ad0','ua044c625da53442ff1040e30bfb1ee28','u93c7c5d46bc99b92c09faede05b7e8b6'];
        return bot; 
    }
    ...
    async textMessage(messages) {
        ...
        this.command(`mention ${payload}`,this.mention.bind(this));
